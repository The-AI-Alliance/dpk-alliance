...
class AbstractTableTransformTest(AbstractTest):
    ...
    def _install_test_fixtures(self, metafunc):
        ...
        if (
            ...
            metafunc.parametrize(
                "transform,in_table_list,expected_table_list,expected_metadata_list", f
            )
    ...
    def test_transform(
        ...
        AbstractTableTransformTest.validate_expected_tables(
            all_table_list, expected_table_list
        )
        AbstractTableTransformTest.validate_expected_metadata_lists(
